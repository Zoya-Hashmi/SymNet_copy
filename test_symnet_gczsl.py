...
def main():
    train_dataset = CompositionDatasetActivations(name, root, phase, feat_file)
    # test_dataset = CompositionDatasetActivations(name, root, "test", feat_file,with_image=True)
    val_dataset = CompositionDatasetActivations(name, root, "val", feat_file)
    # /content/SymNet/data/ut-zap50k-natural/features.t7

# test_loader_notransform = DataLoader(test_dataset, batch_size =64)
